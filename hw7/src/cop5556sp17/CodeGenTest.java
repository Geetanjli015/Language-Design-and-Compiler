...
public class CodeGenTest {
	...
	String[] args = new String[]{"images\\bj.jpg"}; //create command line argument array to initialize params
	Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
	String expOut = "readFromFile(images\\bj.jpg)createOrSetFrameshowImage";
	ByteArrayOutputStream outContent = new ByteArrayOutputStream();
	PrintStream oldStream = System.out;
	    System.setOut(new PrintStream(outContent));
	    instance.run();
	...
	public void readFromURLandWriteToFile3() throws Exception {
		...
		String[] args = new String[] { "http://i.imgur.com/nj0smCy.jpg",
				"images\\bj.jpg" };
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		String expOut = "getURL(http://i.imgur.com/nj0smCy.jpg)readFromURL(http://i.imgur.com/nj0smCy.jpg)grayOpwrite(images\\bj.jpg)";
		ByteArrayOutputStream outContent = new ByteArrayOutputStream();
		PrintStream oldStream = System.out;
		    System.setOut(new PrintStream(outContent));
		    instance.run();
